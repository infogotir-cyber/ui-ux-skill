...
|---|---|---|
| Enrique Esmilse Donna | 550€ "Visado" `mfjQpOhOJcX3oLF77mkC` (⚠️ discrepancia sin resolver, distinta de antes: tag ya corregido a "cualificado visado" el 29 ago, pero el precio que se le mandó — 825€ normal / 750€ con descuento — es el esquema de **estancia**, no el de visado desde origen documentado en `comercial/CLAUDE.md` §1.2, que es 668€ repartido 50/50. Con la etiqueta ya en visado, vale la pena que Mariano confirme si el precio que se le comunicó es el correcto para este caso o si hay que aclararle algo a Enrique.) | **Resuelto 29 ago 2026**: la respuesta de precio ya se mandó y quedó cargada como nota de seguimiento en GHL. Confirmó que cobra el miércoles que viene y el plan de viajar él + su hija Abigaíl primero, reagrupación del resto en ~4 meses. Sin acción pendiente hasta el miércoles. |
